...
SELECT fd.id, seed.fee_code, seed.name, seed.name_ar, seed.description, seed.description_ar,
       ...
       seed.ssb_approved, CURRENT_DATE, 'SSB-SEED-2026', seed.fee_type, seed.flat_amount, seed.percentage_rate,
       seed.minimum_amount, seed.maximum_amount, seed.tier_decision_table_code, seed.formula_expression,
       seed.applicable_contract_types::jsonb, seed.applicable_product_codes::jsonb, seed.applicable_transaction_types::jsonb,
       seed.fee_category, seed.charge_frequency, seed.charge_timing, seed.income_gl_account, seed.is_charity_routed,
       seed.charity_gl_account, seed.percentage_of_financing_prohibited, TRUE,
       seed.maximum_as_percent_of_financing, seed.annual_penalty_cap_amount, seed.status, CURRENT_DATE,
       NULL, 'SYSTEM', 'SYSTEM'
FROM fee_definition fd
JOIN (
    VALUES
        ('IJR-FEE-DOC-001','Documentation Fee','رسوم التوثيق','Fee for preparation and registration of lease documentation','رسوم إعداد وتسجيل مستندات الإجارة','UJRAH_PERMISSIBLE','Fee for preparation and registration of lease documentation','رسوم إعداد وتسجيل المستندات','AAOIFI FAS 8','true','FLAT',500.00,NULL,NULL,NULL,NULL,NULL,'["IJARAH"]','[]','["DISBURSEMENT"]','DOCUMENTATION','ONE_TIME','AT_INCEPTION','5500-FEE-001','false',NULL,'true',1.0000,NULL,'ACTIVE'),
