...
final class MurabahaSupport {
    ...
    static MurabahaApplicationResponse toApplicationResponse(MurabahaApplication application, List<String> warnings) {
        return MurabahaApplicationResponse.builder()
                ...
                .creditAssessmentNotes(application.getCreditAssessmentNotes())
                .creditAssessmentBy(application.getCreditAssessmentBy())
                .creditAssessmentAt(application.getCreditAssessmentAt())
                .monthlyIncome(application.getMonthlyIncome())
                .existingFinancingObligations(application.getExistingFinancingObligations())
                ...
                .supplierQuoteAmount(application.getSupplierQuoteAmount())
                .supplierQuoteRef(application.getSupplierQuoteRef())
                .supplierQuoteExpiry(application.getSupplierQuoteExpiry())
    ...
    static MurabahaContractResponse toContractResponse(MurabahaContract contract) {
        return MurabahaContractResponse.builder()
                ...
                .latePenaltyMethod(contract.getLatePenaltyMethod())
                .takafulRequired(contract.getTakafulRequired())
                .takafulPolicyRef(contract.getTakafulPolicyRef())
                .collateralRequired(contract.getCollateralRequired())
                .collateralDescription(contract.getCollateralDescription())
                .collateralValue(contract.getCollateralValue())
                .impairmentProvisionBalance(contract.getImpairmentProvisionBalance())
                .lastProfitRecognitionDate(contract.getLastProfitRecognitionDate())
                ...
                .ownershipSequence(contract.getOwnershipSequence())
                .earlySettlementAllowed(contract.getEarlySettlementAllowed())
                .build();
    }
