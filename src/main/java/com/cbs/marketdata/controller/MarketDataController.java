...
public class MarketDataController {
    ...
    @GetMapping("/signals") @PreAuthorize("hasAnyRole('CBS_ADMIN','CBS_OFFICER')") public ResponseEntity<ApiResponse<List<MarketSignal>>> listSignals() { return ResponseEntity.ok(ApiResponse.ok(service.getAllSignals())); }
