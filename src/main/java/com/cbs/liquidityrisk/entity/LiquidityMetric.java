...
public class LiquidityMetric {
    ...
    @Builder.Default private BigDecimal hqlaLevel1 = BigDecimal.ZERO;
    @Builder.Default private BigDecimal hqlaLevel2a = BigDecimal.ZERO;
    @Builder.Default private BigDecimal hqlaLevel2b = BigDecimal.ZERO;
    @Builder.Default private BigDecimal totalHqla = BigDecimal.ZERO;
    @Builder.Default private BigDecimal netCashOutflows30d = BigDecimal.ZERO;
    ...
    private BigDecimal top10DepositorPct; private BigDecimal wholesaleFundingPct;
