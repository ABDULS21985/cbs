...
@Entity
@Table(name = "per_transaction", schema = "cbs")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class PerTransaction {
    ...
    private PerTransactionType transactionType;
    ...
    @Column(name = "gross_profit_for_period", precision = 18, scale = 2)
    private BigDecimal grossProfitForPeriod;

    @Column(name = "actual_profit_rate", precision = 8, scale = 4)
    private BigDecimal actualProfitRate;

    @Column(name = "distributed_profit_rate", precision = 8, scale = 4)
    private BigDecimal distributedProfitRate;
