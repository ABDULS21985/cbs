...
@Entity
@Table(name = "irr_policy", schema = "cbs")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class IrrPolicy {
    ...
    @Builder.Default
    private IrrRetentionAllocation retentionAllocation = IrrRetentionAllocation.FROM_INVESTOR_SHARE_ONLY;
