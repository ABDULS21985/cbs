...
public class GeneralLedgerController {
    ...
    private GlAccountResponse toGlAccountResponse(ChartOfAccounts account) {
        return new GlAccountResponse(
                account.getId(),
                account.getGlCode(),
                account.getGlName(),
                account.getGlCategory(),
                account.getGlSubCategory(),
                account.getParentGlCode(),
                account.getLevelNumber(),
                account.getIsHeader(),
                account.getIsPostable(),
                account.getCurrencyCode(),
                account.getIsMultiCurrency(),
                account.getBranchCode(),
                account.getIsInterBranch(),
                account.getNormalBalance(),
                account.getAllowManualPosting(),
                account.getRequiresCostCentre(),
                account.getIsActive(),
