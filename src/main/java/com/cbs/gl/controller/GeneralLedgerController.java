...
public class GeneralLedgerController {
    ...
    public ResponseEntity<ApiResponse<GlAccountResponse>> createGlAccount(@Valid @RequestBody CreateGlAccountRequest request) {
    ...
    public ResponseEntity<ApiResponse<SubledgerReconRunResponse>> runRecon(
        ...
        return ResponseEntity.ok(ApiResponse.ok(toSubledgerReconRunResponse(
                glService.runReconciliation(subledgerType, glCode, subledgerBalance, reconDate))));
    }
