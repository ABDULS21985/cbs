...
@Entity @Table(name = "encryption_key", schema = "cbs")
...
public class EncryptionKey {
    ...
    @Column(length = 80) private String kekId;
    @Column(length = 200) private String hsmKeyHandle;
    @Column(nullable = false, length = 30) @Builder.Default private String algorithm = "AES/GCM/NoPadding";
    @Column(nullable = false) @Builder.Default private Integer keySizeBits = 256;
    @Column(nullable = false, length = 20) @Builder.Default private String status = "ACTIVE";
    @Column(nullable = false) @Builder.Default private Integer rotationIntervalDays = 90;
    private Instant lastRotatedAt;
    private Instant nextRotationAt;
    private Instant expiresAt;
    @Column(length = 80) private String createdBy;
