...
public class CampaignController {
    ...
    @PostMapping("/{code}/approve") @PreAuthorize("hasRole('CBS_ADMIN')") public ResponseEntity<ApiResponse<MarketingCampaign>> approve(@PathVariable String code, @RequestParam String approvedBy) { return ResponseEntity.ok(ApiResponse.ok(service.approve(code, approvedBy))); }
