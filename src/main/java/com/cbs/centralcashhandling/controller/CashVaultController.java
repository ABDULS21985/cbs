...
public class CashVaultController {
    ...
    @GetMapping("/movements") @PreAuthorize("hasAnyRole('CBS_ADMIN','CBS_OFFICER')") public ResponseEntity<ApiResponse<List<CashMovement>>> listAllMovements() { return ResponseEntity.ok(ApiResponse.ok(service.getAllMovements())); }
