...
public class SuitabilityController {
    ...
    @GetMapping("/profiles") @PreAuthorize("hasAnyRole('CBS_ADMIN','CBS_OFFICER')") public ResponseEntity<ApiResponse<java.util.List<ClientRiskProfile>>> listProfiles() { return ResponseEntity.ok(ApiResponse.ok(service.getAllProfiles())); }
    ...
    @GetMapping("/checks") @PreAuthorize("hasAnyRole('CBS_ADMIN','CBS_OFFICER')") public ResponseEntity<ApiResponse<java.util.List<SuitabilityCheck>>> listChecks() { return ResponseEntity.ok(ApiResponse.ok(service.getAllChecks())); }
