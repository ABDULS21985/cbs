...
final class MusharakahSupport {
    ...
    static MusharakahResponses.MusharakahContractResponse toContractResponse(MusharakahContract contract) {
        return MusharakahResponses.MusharakahContractResponse.builder()
                ...
                .rentalRateType(contract.getRentalRateType())
                .rentalBenchmark(contract.getRentalBenchmark())
                .rentalMargin(contract.getRentalMargin())
                .rentalReviewFrequency(contract.getRentalReviewFrequency())
                .nextRentalReviewDate(contract.getNextRentalReviewDate())
                .earlyBuyoutAllowed(contract.getEarlyBuyoutAllowed())
                .earlyBuyoutPricingMethod(contract.getEarlyBuyoutPricingMethod())
                .earlyBuyoutDate(contract.getEarlyBuyoutDate())
                .earlyBuyoutAmount(contract.getEarlyBuyoutAmount())
