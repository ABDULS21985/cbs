...
public final class CardMapper {
    ...
    public static CardTransactionResponse toTxnResponse(CardTransaction t) {
        ...
        return new CardTransactionResponse(
                ...
                t.getFxRate(),
                t.getOriginalTransaction() != null ? t.getOriginalTransaction().getId() : null,
                t.getOriginalTransactionRef(),
                t.getAdjustmentReason(),
                t.getMerchantName(),
                t.getMerchantId(),
                ...
                t.getResponseCode(),
                t.getIslamicCardId(),
                t.getShariahScreeningRef(),
                t.getShariahDecision(),
                t.getShariahReason(),
                t.getStatus(),
                t.getDeclineReason(),
                t.getIsDisputed(),
