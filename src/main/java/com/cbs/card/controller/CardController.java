...
public class CardController {
    ...
    public ResponseEntity<ApiResponse<CardResponse>> updateControls(@PathVariable Long id,
        ...
        return ResponseEntity.ok(ApiResponse.ok(toCardResponse(cardService.updateControls(id, contactless, online, international, atm, pos))));
    }
    ...
    public ResponseEntity<ApiResponse<CardTransactionResponse>> authorize(@PathVariable Long cardId,
        ...
        return ResponseEntity.ok(ApiResponse.ok(toTransactionResponse(cardService.authorizeTransaction(cardId, transactionType, channel,
    ...
    public ResponseEntity<ApiResponse<CardTransactionResponse>> dispute(@PathVariable Long txnId, @RequestParam String reason) {
        return ResponseEntity.ok(ApiResponse.ok(toTransactionResponse(cardService.disputeTransaction(txnId, reason))));
    }
    ...
    public ResponseEntity<ApiResponse<List<CardTransactionResponse>>> getTransactions(@PathVariable Long cardId,
        ...
        return ResponseEntity.ok(ApiResponse.ok(result.getContent().stream().map(this::toTransactionResponse).toList(), PageMeta.from(result)));
    }
    ...
    private CardResponse toCardResponse(Card card) {
        return new CardResponse(
                ...
                card.getAccount() != null ? card.getAccount().getAccountNumber() : null,
    ...
    private CardTransactionResponse toTransactionResponse(CardTransaction txn) {
        return new CardTransactionResponse(
                txn.getId(),
                txn.getTransactionRef(),
                txn.getCard() != null ? txn.getCard().getId() : null,
                txn.getCard() != null ? txn.getCard().getCardReference() : null,
                txn.getAccount() != null ? txn.getAccount().getId() : null,
                txn.getAccount() != null ? txn.getAccount().getAccountNumber() : null,
