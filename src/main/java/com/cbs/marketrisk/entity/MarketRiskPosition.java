...
public class MarketRiskPosition {
    ...
    @Column(name = "var_1d_95") private BigDecimal var1d95;
    @Column(name = "var_1d_99") private BigDecimal var1d99;
    @Column(name = "var_10d_99") private BigDecimal var10d99;
    @Builder.Default private String varMethod = "HISTORICAL";
    private BigDecimal stressLossModerate;
    private BigDecimal stressLossSevere;
    private String stressScenario;
