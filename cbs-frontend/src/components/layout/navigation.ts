    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Escrow & Trust', path: '/accounts/escrow' },
          ...
          { label: 'Statement History', path: '/accounts/statements/history' },
          { label: 'Mini Statement', path: '/accounts/statements/mini' },
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Disputes', path: '/payments/disputes' },
          { label: 'Compliance', path: '/payments/compliance' },
      ...
      {
        label: 'Trade Finance', icon: Globe, path: '/trade-finance', roles: ['CBS_ADMIN', 'CBS_OFFICER'],
        children: [
          { label: 'Dashboard', path: '/trade-finance' },
          { label: 'Letters of Credit', path: '/trade-finance?tab=lcs' },
          { label: 'Guarantees', path: '/trade-finance?tab=guarantees' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { label: 'Dashboard', path: '/contact-center' },
          { label: 'Agent Dashboard', path: '/contact-center/agent' },
          { label: 'Agent Console', path: '/contact-center/agent-console' },
          ...
          { label: 'Center Admin', path: '/contact-center/admin' },
        ],
      },
    ],
  },
