...
export const navigationItems: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Payments', icon: ArrowLeftRight, path: '/payments', roles: ['CBS_ADMIN', 'CBS_OFFICER', 'CBS_VIEWER', 'COMPLIANCE', 'PORTAL_USER'],
        children: [
          { label: 'New Transfer', path: '/payments/new', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'History', path: '/payments/history', roles: ['CBS_ADMIN', 'CBS_OFFICER', 'CBS_VIEWER'] },
          ...
          { label: 'International', path: '/payments/international', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'Remittances', path: '/payments/remittances', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'Payroll', path: '/payments/payroll', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'QR Payments', path: '/payments/qr', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'Mobile Money', path: '/payments/mobile-money', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'Cheques', path: '/payments/cheques', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
          { label: 'Orchestration', path: '/payments/orchestration', roles: ['CBS_ADMIN', 'CBS_OFFICER'] },
        ],
      },
      {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Customer Routing', path: '/contact-center/routing' },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'Wealth Management', path: '/advisory/wealth-management' },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'Liquidity Risk', path: '/treasury/liquidity-risk' },
          { label: 'Market Risk', path: '/treasury/market-risk' },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Valuations', path: '/custody/valuations' },
        ],
      },
      {
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'Credit Margin', path: '/risk/credit-margin' },
        ],
      },
      {
      ...
      {
        label: 'Data Security', icon: Shield, path: '/dspm', roles: ['CBS_ADMIN', 'CBS_OFFICER'],
        children: [
          { label: 'Dashboard', path: '/dspm' },
          { label: 'Data Sources', path: '/dspm/sources' },
          { label: 'Data Scans', path: '/dspm/scans' },
          { label: 'Policies', path: '/dspm/policies' },
          { label: 'Exceptions', path: '/dspm/exceptions' },
          { label: 'Identities', path: '/dspm/identities' },
        ],
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'USSD Simulator', path: '/channels/ussd-simulator' },
          { label: 'Branch Ops', path: '/operations/branches' },
          { label: 'Branch Network', path: '/operations/branch-network' },
          { label: 'Branch Performance', path: '/operations/branch-performance' },
