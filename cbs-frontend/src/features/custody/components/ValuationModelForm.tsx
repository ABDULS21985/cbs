...
const INSTRUMENT_TYPES = ['BOND', 'EQUITY', 'DERIVATIVE', 'FX', 'COMMODITY', 'STRUCTURED_PRODUCT'];
const METHODOLOGIES = ['MARK_TO_MARKET', 'MARK_TO_MODEL', 'DISCOUNTED_CASH_FLOW', 'OPTION_PRICING', 'MONTE_CARLO'];
const FV_LEVELS = ['LEVEL_1', 'LEVEL_2', 'LEVEL_3'];
const CALIBRATION_FREQ = ['DAILY', 'WEEKLY', 'MONTHLY', 'QUARTERLY'];
