...
function mockStats(): DepositStats {
  return {
...
function mockDepositMix(): DepositMixItem[] {
  return [
    {
      name: 'CASA',
...
function mockGrowthTrend(): DepositGrowthPoint[] {
...
function mockTopDepositors(): TopDepositor[] {
...
function mockMaturityProfile(): MaturityBucket[] {
...
function mockRateBands(): RateBand[] {
  const bands = [
...
function mockRateSensitivity(): RateSensitivityPoint[] {
...
function mockCostOfFunds(): CostOfFundsPoint[] {
  const base = subMonths(new Date(), 11);
  return Array.from({ length: 12 }, (_, i) => {
    const p = i / 11;
...
function mockRetentionVintage(): RetentionVintage[] {
...
function mockChurnAnalysis(): ChurnStat {
  return {
    avgTenureMonths: 28,
    totalClosed: 1842,
    reasons: [
...
export const depositAnalyticsApi = {
  getDepositStats: () => delay(mockStats),
  getDepositMix: () => delay(mockDepositMix),
  getDepositGrowthTrend: () => delay(mockGrowthTrend),
  getTopDepositors: () => delay(mockTopDepositors),
  getMaturityProfile: () => delay(mockMaturityProfile),
  getRateBands: () => delay(mockRateBands),
  getRateSensitivityData: () => delay(mockRateSensitivity),
  getCostOfFundsTrend: () => delay(mockCostOfFunds),
  getRetentionVintage: () => delay(mockRetentionVintage),
  getChurnAnalysis: () => delay(mockChurnAnalysis),
};
