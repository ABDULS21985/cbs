...
export function ProviderRegistrationForm({ onSubmit, onCancel }: ProviderRegistrationFormProps) {
  ...
  const fc = (err?: unknown) => cn('w-full px-3 py-2 rounded-md border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/50', err && 'border-red-500');
