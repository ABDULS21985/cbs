...
export const mockUser = {
  id: 1,
  username: 'amara.officer',
  fullName: 'Amara Okonkwo',
  email: 'amara@cbs.bank',
  roles: ['CBS_OFFICER'],
  permissions: [],
  branchId: 1,
...
export const handlers = [
  ...
  http.get('/api/v1/customers', ({ request }) => {
    ...
    return HttpResponse.json({
      success: true,
      data: [mockCustomer],
      page: { page, size: 10, totalElements: 1, totalPages: 1 },
  ...
  http.get('/api/v1/accounts/selector', () =>
    HttpResponse.json([
      { id: 'acc-1', label: '0123456789 — Amara Okonkwo' },
      { id: 'acc-2', label: '0234567890 — TechVentures Ltd' },
    ])
  ),
  ...
  // Default catch-all: return empty success
  http.get('/api/v1/*', () =>
